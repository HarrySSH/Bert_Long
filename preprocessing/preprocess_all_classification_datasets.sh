...
TASK=theraputics
mkdir -p ${TASKS_DIR}/${TASK}
cp ${THERAPUTIC_DIR}/train.tsv ${TASKS_DIR}/${TASK}/train.tsv
cp ${THERAPUTIC_DIR}/dev.tsv ${TASKS_DIR}/${TASK}/dev.tsv
cp ${THERAPUTIC_DIR}/test.tsv ${TASKS_DIR}/${TASK}/test.tsv
