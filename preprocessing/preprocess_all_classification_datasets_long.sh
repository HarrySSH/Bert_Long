...
THERAPUTIC_DIR=${RAW_DATA_DIR}/theraputics_raw_data
...
# Process BioBERT datasets:
echo "#######################################"
echo "##### Processing THERAPUTIC #####"
echo "#######################################"
TASK=theraputics
mkdir -p ${TASKS_DIR}/${TASK}
cp ${THERAPUTIC_DIR}/train_long.tsv ${TASKS_DIR}/${TASK}/train_long.tsv
cp ${THERAPUTIC_DIR}/dev_long.tsv ${TASKS_DIR}/${TASK}/dev_long.tsv
cp ${THERAPUTIC_DIR}/test_long.tsv ${TASKS_DIR}/${TASK}/test_long.tsv
