...
MODEL_TYPE="bert"
CHECKPOINT_DIR="/wynton/protected/project/outcome_pred/ucsf_bert_pytorch/512/500k-75k/"
MAX_SEQ_LEN=512
run=0
#biolm-70k-512
rm /wynton/protected/project/outcome_pred/Harry_workspace/codes/bio-lm/data/tasks/theraputics/cached*
mkdir /wynton/protected/project/outcome_pred/Harry_workspace/Theraputics/bert/biolm-500k-75k-$MAX_SEQ_LEN
rm -rf /wynton/protected/project/outcome_pred/Harry_workspace/Theraputics/bert/biolm-500k-75k-$MAX_SEQ_LEN/*
...
for seed in {10,20,30,40,50}; do
  ...
  OUTPUT_DIR="/wynton/protected/project/outcome_pred/Harry_workspace/Theraputics/bert/biolm-500k-75k-$MAX_SEQ_LEN/run${run}/"
  CUDA_VISIBLE_DEVICES=$SGE_GPU python -m biolm.run_classification_long \
    --task_name ${TASK}\
    --data_dir ${DATADIR}\
