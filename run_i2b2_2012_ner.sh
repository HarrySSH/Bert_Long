...
TASK="I2B22012"
MAX_SEQ_LEN=128
DATADIR="data/tasks/I2B22012NER.model=ucsf-bert.maxlen=${MAX_SEQ_LEN}"
MODEL_TYPE="bert"
...
for seed in {10,20,30,40,50}; do
  (( run++ ))
  OUTPUT_DIR="/wynton/protected/project/fda_adr/msushil/finetuning_models/i2b2_2012_ner/bert/biolm-500k-128/run${run}/"
