...
MODEL_TYPE="bert"
CHECKPOINT_DIR="/wynton/protected/project/outcome_pred/ucsf_bert_pytorch/512/70k"
MAX_SEQ_LEN=512
run=0
...
for seed in {10,20,30,40,50}; do
  ...
  #OUTPUT_DIR="/wynton/protected/project/outcome_pred/Harry_workspace/Theraputics/bert/biolm-500k-28k-$MAX_SEQ_LEN/run${run}/"
