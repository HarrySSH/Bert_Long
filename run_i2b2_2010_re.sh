...
TASK="i2b22010re"
DATADIR="data/tasks/I2B21010RE/"
MODEL_TYPE="bert"
CHECKPOINT_DIR="/wynton/protected/project/fda_adr/msushil/bert_models/3/pytorch/500k/"
# OUTPUT_DIR="/wynton/protected/project/fda_adr/msushil/finetuning_models/i2b2_2010/bert/biolm-500k-128/run3/"
MAX_SEQ_LEN=128
run=0
for seed in {10,20,30,40,50}; do
  (( run++ ))
  OUTPUT_DIR="/wynton/protected/project/fda_adr/msushil/finetuning_models/i2b2_2010_re/bert/biolm-500k-128/run${run}/"
